        ...
        switch (apiMethod) {
            ...
            case "Brightness":
                if (!Settings.System.canWrite(context)) {
                    ...
                    Toast.makeText(context, "Please enable permission for " + ShiroikumaConstants.APP_NAME, Toast.LENGTH_LONG).show();
            ...
            case "NotificationList":
                ...
                if (!NotificationServiceEnabled) {
                    Toast.makeText(context,"Please give " + ShiroikumaConstants.APP_NAME + " Notification Access", Toast.LENGTH_LONG).show();
